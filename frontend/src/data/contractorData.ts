...
export const REGISTERED_VENDORS: VendorDetails[] = [
  {
    ...
    firmName: "Gurugram Metropolitan Development Authority (GMDA)",
    registrationClass: "Class A (Apex)",
    contactPerson: "Er. Vikas Rao (Chief Engineer)",
    phone: "+91 99990 12345",
    email: "gmda.gurugram@haryana.gov.in",
  ...
  {
    vendorId: "VEN-HR-GGM-02",
    firmName: "Municipal Corporation Gurugram (MCG)",
    registrationClass: "Class A (Apex)",
    contactPerson: "Er. Sandeep Yadav (Superintending Engineer)",
    phone: "+91 98188 33445",
    email: "mcg.gurugram@haryana.gov.in",
  ...
  {
    vendorId: "VEN-HR-RTK-01",
    firmName: "Public Health Engineering Department (PHED), Rohtak",
    registrationClass: "Class A (Apex)",
    contactPerson: "Er. Surender Malik (Executive Engineer)",
    phone: "+91 98120 44556",
    email: "phed.rohtak@haryana.gov.in",
    gstin: "06AACHP5512K1Z9",
    district: "Rohtak",
    state: "Haryana",
    activeWorksCount: 6,
  ...
  {
    vendorId: "VEN-HR-RTK-02",
    firmName: "Public Works Department (PWD B&R), Rohtak",
    registrationClass: "Class A (Apex)",
    contactPerson: "Er. Ramesh Chaudhary (Superintending Engineer)",
    phone: "+91 98124 77889",
    email: "pwd.rohtak@haryana.gov.in",
