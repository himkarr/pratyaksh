...
export const ROHTAK_WORKS: WorkItem[] = [
  {
    id: "WORK-HR-RTK-001",
    ...
    dateSanctioned: "2024-03-15",
    targetCompletion: "2025-04-30",
    status: "Ongoing",
    agency: "Public Health Engineering Department, Rohtak",
  ...
  },
  {
    ...
    status: "Completed",
    agency: "Public Works Department (PWD), Rohtak",
    contractor: "M/s Haryana Civil Infra Services",
    rating: 4.9,
    reviewsCount: 22,
    attachments: [],
  ...
  },
  {
    ...
    targetCompletion: "2025-05-31",
    status: "Ongoing",
    agency: "Education Infrastructure Cell, Rohtak",
    contractor: "M/s Apex Infra & Construction Ltd.",
    rating: 4.5,
    reviewsCount: 6,
    attachments: [],
  ...
  },
  {
    ...
    status: "Delayed",
    agency: "Municipal Committee Meham",
    contractor: "M/s Haryana Civil Infra Services",
    rating: 3.9,
    reviewsCount: 4,
    attachments: [],
...
export const GURUGRAM_WORKS: WorkItem[] = [
  {
    id: "WORK-HR-GGM-001",
    ...
    targetCompletion: "2025-03-31",
    status: "Ongoing",
    agency: "Gurugram Metropolitan Development Authority (GMDA)",
  ...
  },
  {
    ...
    physicalProgress: 100,
    financialProgress: 100,
    dateSanctioned: "2024-01-05",
    targetCompletion: "2024-10-15",
    status: "Completed",
    agency: "Public Health Engineering Dept, Gurugram",
    contractor: "M/s Millennium City Builders & Engineers",
    rating: 4.9,
    reviewsCount: 25,
    attachments: [],
  ...
  },
  {
    ...
    targetCompletion: "2025-04-11",
    status: "Ongoing",
    agency: "Zilla Parishad Gurugram",
    contractor: "M/s Millennium City Builders & Engineers",
    rating: 4.6,
    reviewsCount: 11,
    attachments: [],
  ...
  },
  {
    ...
    physicalProgress: 20,
    financialProgress: 22,
    dateSanctioned: "2024-05-18",
    targetCompletion: "2025-06-30",
    status: "Sanctioned",
    agency: "Health Infrastructure Division, Gurugram",
    contractor: "M/s Millennium City Builders & Engineers",
    rating: 4.4,
    reviewsCount: 7,
    attachments: [],
...
export const INITIAL_WORKS: WorkItem[] = [
  ...
  ...ROHTAK_WORKS,
  ...GURUGRAM_WORKS,
  ...(officialWorksRaw as unknown as WorkItem[])
];
