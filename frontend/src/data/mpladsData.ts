...
export const ROHTAK_WORKS: WorkItem[] = [
  ...
  },
  {
    ...
    targetCompletion: "2025-03-31",
    status: "Ongoing",
    agency: "Public Health Engineering Dept (PHED), Rohtak",
    contractor: "M/s Rohtak Development & Builders Ltd.",
    rating: 4.7,
    reviewsCount: 11,
    attachments: [],
  ...
  },
  {
    ...
    physicalProgress: 100,
    financialProgress: 100,
    dateSanctioned: "2023-11-05",
    targetCompletion: "2024-10-30",
    status: "Completed",
    agency: "Haryana Urban Development Authority (HUDA), Rohtak",
    contractor: "M/s Apex North Infrastructure Pvt Ltd.",
    rating: 4.9,
    reviewsCount: 35,
    attachments: [],
  ...
  },
  {
    ...
    targetCompletion: "2025-05-09",
    status: "Sanctioned",
    agency: "District Health Society, Rohtak",
    contractor: "M/s Haryana Civil Infra Services",
    rating: 4.4,
    reviewsCount: 5,
    attachments: [],
  ...
  },
  {
    ...
    dateSanctioned: "2024-02-01",
    targetCompletion: "2025-06-30",
    status: "Ongoing",
    agency: "Public Works Department (B&R), Rohtak",
    contractor: "M/s Rohtak Development & Builders Ltd.",
    rating: 4.8,
    reviewsCount: 16,
    attachments: [],
  ...
  },
  {
    ...
    dateSanctioned: "2024-01-20",
    targetCompletion: "2024-09-30",
    status: "Completed",
    agency: "Women & Child Development Dept, Rohtak",
    contractor: "M/s Apex North Infrastructure Pvt Ltd.",
    rating: 4.7,
    reviewsCount: 12,
    attachments: [],
  ...
  },
  {
    ...
    targetCompletion: "2025-04-04",
    status: "Ongoing",
    agency: "Municipal Corporation Rohtak",
    contractor: "M/s Haryana Civil Infra Services",
    rating: 4.6,
    reviewsCount: 8,
    attachments: [],
...
export const JIND_WORKS: WorkItem[] = [
  {
    id: "WORK-HR-JIN-001",
    title: "Installation of Solar High-Mast Street Lighting System at New Grain Market Chowk, Jind",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Jind",
    constituency: "Jind",
    ...
    financialProgress: 100,
    dateSanctioned: "2024-02-15",
    targetCompletion: "2024-07-30",
    status: "Completed",
    agency: "Haryana Renewable Energy Development Agency (HAREDA), Jind",
    contractor: "M/s Surya Power Grid Solutions",
    rating: 4.9,
    reviewsCount: 22,
    attachments: [],
    reviews: []
  ...
  {
    id: "WORK-HR-JIN-002",
    title: "Construction of Cement Concrete Link Road connecting Safidon to Jind Highway",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Jind",
    constituency: "Jind",
    ...
    targetCompletion: "2025-04-30",
    status: "Ongoing",
    agency: "Public Works Department (B&R), Jind",
    contractor: "M/s Haryana Infrastructure & Highways Pvt Ltd",
    rating: 4.7,
    reviewsCount: 14,
    attachments: [],
    reviews: []
  ...
  {
    id: "WORK-HR-JIN-003",
    title: "Installation of 5,000 LPH Community Solar RO Drinking Water Purification Plant, Urban Estate Jind",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Jind",
    constituency: "Jind",
    ...
    dateSanctioned: "2024-04-10",
    targetCompletion: "2024-11-30",
    status: "Ongoing",
    agency: "Public Health Engineering Department (PHED), Jind",
    contractor: "M/s PureAqua Tech Systems Ltd",
    rating: 4.8,
    reviewsCount: 18,
    attachments: [],
    reviews: []
  ...
  {
    id: "WORK-HR-JIN-004",
    title: "Upgradation of Science & Computer Laboratories at Govt PG College for Women, Jind",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Jind",
    constituency: "Jind",
    ...
    physicalProgress: 100,
    financialProgress: 100,
    dateSanctioned: "2024-01-25",
    targetCompletion: "2024-08-15",
    status: "Completed",
    agency: "Higher Education Department, Haryana",
    contractor: "M/s EduBuild Infotech Services",
    rating: 4.9,
    reviewsCount: 29,
    attachments: [],
    reviews: []
...
export const GURUGRAM_WORKS: WorkItem[] = [
  {
    ...
    targetCompletion: "2025-03-31",
    status: "Ongoing",
    agency: "Office of District Magistrate & Collector (IDA), Gurugram",
  ...
  },
  {
    ...
    status: "Completed",
    agency: "Office of District Magistrate & Collector (IDA), Gurugram",
    contractor: "M/s Gurugram Urban Infra Project Ltd.",
    rating: 4.9,
    reviewsCount: 25,
    attachments: [],
    reviews: []
  },
  {
    ...
    status: "Ongoing",
    agency: "Office of District Magistrate & Collector (IDA), Gurugram",
    contractor: "M/s Cyber City Infrastructure Pvt Ltd.",
    rating: 4.6,
    reviewsCount: 11,
    attachments: [],
    reviews: []
  ...
  {
    id: "WORK-HR-GGM-005",
    title: "Construction of Jat Community Center & Cultural Hall, Sector 10",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-006",
    title: "Installation of 2 Submersible Tube Wells & Bores in BPL and SC Colony",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-007",
    title: "Laying Sewerline Pipeline & Interceptor Network, Wazirabad Sub-Division",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
    ...
    mpName: "Shri Rao Inderjit Singh",
    category: "Sanitation",
    sectorName: "Sanitation",
    recommendedAmt: 1.20,
    sanctionedAmt: 1.20,
    expenditureAmt: 0.60,
    physicalProgress: 50,
    financialProgress: 50,
    dateSanctioned: "2024-02-14",
    targetCompletion: "2025-04-30",
    status: "Ongoing",
    agency: "Office of District Magistrate & Collector (IDA), Gurugram",
    contractor: "M/s Cyber City Infrastructure Pvt Ltd.",
  ...
  {
    id: "WORK-HR-GGM-008",
    title: "Construction of Concrete Approach Road from PWD Highway to Govt. Middle School, Manesar",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-009",
    title: "Construction of Road from Rampur Gaushala Road to Khandewla Village Road",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-010",
    title: "Construction of Student Hostel Building in Ashram Hari Mandir Sanskrit Mahavidhyalay, Pataudi",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-011",
    title: "Construction of Animal Shelters (Tin Shed & Ventilation Framework), Garhi Harsaru",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-012",
    title: "Modern Press Conference Hall & Media Center in Existing District Administrative Building",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-013",
    title: "Construction of Rural General Choupal & Multi-Purpose Hall, Kadipur Block",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-014",
    title: "Upgradation & Additional Rooms in Jat Kalyan Sabha Complex, Sector 10",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
  ...
  {
    id: "WORK-HR-GGM-015",
    title: "Construction of Eco-Friendly Energy Efficient Crematorium & Shelter Shed, Farrukhnagar",
    house: "Lok Sabha",
    state: "Haryana",
    district: "Gurugram",
    constituency: "Gurugram (PC-09)",
    ...
    sectorName: "Civic Infrastructure",
    recommendedAmt: 0.75,
    sanctionedAmt: 0.75,
    expenditureAmt: 0.75,
    physicalProgress: 100,
