...
export const TRANSLATIONS: Record<'en' | 'hi', TranslationDict> = {
  en: {
    ...
    fundLedgerTab: "e-SAKSHI Fund Ledger & Vouchers",
  ...
  hi: {
    portalTitle: "सांसद स्थानीय क्षेत्र विकास योजना (MPLADS e-SAKSHI)",
    ...
    fundLedgerTab: "ई-साक्षी निधि बहीखाता एवं वाउचर",
...
const HINDI_PHRASE_MAP: Record<string, string> = {
  ...
  "e-SAKSHI Fund Ledger & Vouchers": "ई-साक्षी निधि बहीखाता एवं वाउचर",
